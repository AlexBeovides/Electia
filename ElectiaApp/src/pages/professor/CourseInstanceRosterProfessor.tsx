...
export const CourseInstanceRosterProfessor = () => { 
    ...
    useEffect(() => {
        const fetchStudents = async () => {
            try { 
                ...
                //newStudents son los tipos q aplicaron y no fueron aceptados, q puedes annadir manualmente
          ...
          <div className="manager-page-container">
            ...
            <div className="section-container"> 
                <div className="table-container">
                    ...
                    <br></br>
                    <a href={`${window.location.origin}/electia-app/professor/course-instance-grades/?courseId=${courseInstanceId}`}>Notas del Curso</a>
                    <br></br>
                    <br></br> 
