...
export const CourseInstanceGradesProfessor = () => {
    ...
    const [colDefs, setColDefs] = useState<ColDef<IRow>[]>([
        ...
        {
            field: "extraGrade",
            headerName: 'Examen Extraordinario',
            editable: (params) => !!params.data?.finalGrade, // 👈 Solo editable si hay nota final
            filter: true,
            cellEditor: "agSelectCellEditor",
            cellEditorParams: {
                values: [null, 2, 3, 4, 5],
        ...
        {
            field: "mundialGrade",
            headerName: 'Examen Mundial',
            editable: (params) => !!params.data?.extraGrade, // 👈 Solo editable si hay nota extra
            filter: true,
            cellEditor: "agSelectCellEditor",
            cellEditorParams: {
                values: [null, 2, 3, 4, 5],
        ...
        { field: "comment", headerName: 'Comentario', editable: true },
    ]);
    ...
    const onCellValueChanged = (params: any) => {
        ...
        fetch(`${API_BASE_URL}/CourseGrades/ByProfessor/${updatedData.id}`, {
          method: 'PUT',
          headers: {
            ...
            body: JSON.stringify({
                id: updatedData.id,
                grade1: updatedData.finalGrade,
                grade2: updatedData.extraGrade,
                grade3: updatedData.mundialGrade,
            ...
            <div className="section-container">     
                ...
                <div className="table-container">
                    <div className="navigation-links">
                        <a href={`${window.location.origin}/electia-app/professor/courses/?courseId=${courseData?.id}`}>Información del Curso</a>
                        <br></br>       
                        <a href={`${window.location.origin}/electia-app/professor/course-instance-roster/?courseId=${courseInstanceId}`}>Matrícula del Curso</a>
                    </div>
