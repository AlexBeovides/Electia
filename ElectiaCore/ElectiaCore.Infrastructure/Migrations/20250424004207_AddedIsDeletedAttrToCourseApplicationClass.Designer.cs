...
namespace ElectiaCore.Infrastructure.Migrations
{
    ...
    [Migration("20250424004207_AddedIsDeletedAttrToCourseApplicationClass")]
    partial class AddedIsDeletedAttrToCourseApplicationClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseProfessor", b =>
                {
                    b.Property<int>("CollaboratingCoursesId")
                        .HasColumnType("int");

                    b.Property<string>("CollaboratingProfessorsUserId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("CollaboratingCoursesId", "CollaboratingProfessorsUserId");

                    b.HasIndex("CollaboratingProfessorsUserId");

                    b.ToTable("CourseCollaboratingProfessors", (string)null);
                });
            ...
            modelBuilder.Entity("CourseProfessor", b =>
                {
                    b.HasOne("ElectiaCore.Domain.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("CollaboratingCoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ElectiaCore.Domain.Entities.Professor", null)
                        .WithMany()
                        .HasForeignKey("CollaboratingProfessorsUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
